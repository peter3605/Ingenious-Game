...
public class GameBoard extends JPanel implements Runnable,MouseListener,MouseMotionListener{
	...
	private void horizontalLines(Graphics g){
		...
		for (int counter=0;counter< game.getPlayers().length;counter++){
			...
			{
				//System.out.println("SCORE RED: " + game.getPlayers()[counter].getScores()[3]);
			...
			{
				//System.out.println("SCORE BLUE: " + game.getPlayers()[counter].getScores()[5]);
			...
			{
				//System.out.println("SCORE GREEN: " + game.getPlayers()[counter].getScores()[4]);
			...
			{
				//System.out.println("SCORE ORANGE: " + game.getPlayers()[counter].getScores()[0]);
			...
			{
				//System.out.println("SCORE YELLOW: " + game.getPlayers()[counter].getScores()[1]);
			...
			{
				//System.out.println("SCORE MAGENTA: " + game.getPlayers()[counter].getScores()[2]);
