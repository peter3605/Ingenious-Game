...
//		System.out.println("low Color");
//		for (int a = 0; a < lowestColor.size(); a++) {
//			System.out.println(lowestColor.get(a));
//		}
				...
				for (int y = 0; y < 15; y++) {
					for (int o = 0; o < 6; o++) {
						for (int piece = 0; piece < game.currentPlayer.getHand().getSize(); piece++) {
							...
							//	System.out.println(lowestColor.get(i));
			...
			for (int y = 0; y < 15; y++) {
				for (int o = 0; o < 6; o++) {
					for (int piece = 0; piece < game.currentPlayer.getHand().getSize(); piece++) {
						...
						if ((isColor1 || isColor2) && game.checkLegalMove(o, x, y, color1, color2)) {
							makeTempGrid(o, x, y, color1, color2);
							//System.out.println(game.score(x, y, tempGrid));
